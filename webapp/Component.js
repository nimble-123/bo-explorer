...
sap.ui.define([
		...
		"sap/ui/Device",
		"dev/bo-explorer/model/models",
		"dev/bo-explorer/controller/ErrorHandler",
		"sap/ui/model/json/JSONModel",
		"dev/bo-explorer/controller/util/ConfigUtil",
		"dev/bo-explorer/controller/util/APIInfo",
		"dev/bo-explorer/util/DocumentationRouter", // used via manifest.json
		...
		return UIComponent.extend("dev.bo-explorer.Component", {
