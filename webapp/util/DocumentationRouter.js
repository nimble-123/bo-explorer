...
sap.ui.define([
	...
	var DocumentationRouter = Router.extend("dev.bo-explorer.util.DocumentationRouter", {
		...
		_onTopicOldRouteMatched: function(oEvent) {
			...
			this.getView("dev.bo-explorer.view.App", "XML", "app").loaded().then(function(oView) {
