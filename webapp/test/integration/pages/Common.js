sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("dev/bo-explorer/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("dev.bo-explorer.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["dev/bo-explorer/localService/mockserver"], function (mockserver) {
