...
sap.ui.define([
		...
		"dev/bo-explorer/controller/util/ControlsInfo",
		"dev/bo-explorer/util/ToggleFullScreenHandler",
		"dev/bo-explorer/controller/util/APIInfo",
		"sap/ui/core/library",
		"sap/base/log"
		...
		return BaseController.extend("dev.bo-explorer.controller.Detail", {
			...
			onInit: function () {
				...
				this._oContainerPage = this.getView().byId("detailPageContainer");
			},
			...
			_createModelAndSubView: function (oBorrowedData) {
				...
				this._oView = sap.ui.view({
					height: "100%",
					viewName: "dev.bo-explorer.view.SubDetail",
					type: ViewType.XML,
					async: true,
					preprocessors: {
						xml: {
