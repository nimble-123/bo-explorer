...
sap.ui.define([
		"jquery.sap.global",
		"sap/ui/Device",
		"dev/bo-explorer/controller/MasterTreeBaseController",
		"sap/m/library"
		...
		return MasterTreeBaseController.extend("dev.bo-explorer.controller.Master", {
			...
			onNodeSelect : function (oEvent) {
				...
				if (!apiId) {
					jQuery.sap.log.warning("Missing name for entity: " + node.getId() + " - cannot navigate to BO ref");
					return;
				}
